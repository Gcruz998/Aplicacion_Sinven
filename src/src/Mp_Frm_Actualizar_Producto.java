 ...
 * @author Membreño
 */
public class Mp_Frm_Actualizar_Producto extends javax.swing.JFrame {
        
        private int secuenciausuario = 0;
        JFrame producto = new JFrame();
    public Mp_Frm_Actualizar_Producto() {
        initComponents();
        producto.setVisible(true);
        producto.setContentPane(jPanel2);
        producto.pack();
        producto.setLocationRelativeTo(null);
        producto.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        producto.setTitle("Actualizar Productos");
        traerproducto();
    ...
    public void traerproducto(){
        ...
        ResultSet consulta = Ms_Conexion.Consulta("SELECT [Secuencia_Registro_Producto],[Nombre_Corto_Producto],[Descripcion_Producto],[Precio_Mayorista],[Precio_Minorista],[Secuencia_Categoria_Productos],[Secuencia_Unidad_Medida_Producto]" +
                            "  FROM [SRV_BD_APP_SINVEN].[dbo].[TBL_MP_REGISTRO_MAESTRO_PRODUCTOS]" +
                            "  WHERE [Descripcion_Producto] ='"+descripcion+"'");
        
        try {
            consulta.next();
            secuenciausuario=consulta.getInt(1);
            Txt_Nombre_Corto_Producto.setText(consulta.getString(2));
            Txt_Descripcion_Producto.setText(consulta.getString(3));           
            Txt_Precio_Mayorista.setText(consulta.getString(4));
            Txt_Precio_Minorista.setText(consulta.getString(5));
...
"   SET [Nombre_Corto_Producto] = " + "'"+ Txt_Nombre_Corto_Producto.getText()  +"'"+
"      ,[Descripcion_Producto] = " +"'"+ Txt_Descripcion_Producto.getText()  +"'"+
"      ,[Precio_Mayorista] = " +Txt_Precio_Mayorista.getText() +
"      ,[Precio_Minorista] = " +Txt_Precio_Minorista.getText()+
"      ,[Fecha_Actualizacion_Registro_Productos] = " +"'"+ HoraActual()  +"'"+
"      ,[Secuencia_Categoria_Productos] = " +CategoriaProducto()  +
"      ,[Secuencia_Unidad_Medida_Producto] = " +UnidadProducto()  +
                " WHERE Secuencia_Registro_Producto = "+ secuenciausuario);
    ...
    private void initComponents() {
        ...
        BotonActualizardatos.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        ...
        Botonverificar.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(103, 103, 103)
                        .addComponent(Botonverificar, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(80, 80, 80)
                        .addComponent(BotonActualizardatos, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(74, 74, 74)
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(Box_Categoria_Producto, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(161, 161, 161)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
